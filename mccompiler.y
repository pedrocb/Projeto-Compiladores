...
%type <n> TypeSpec Subfactor Expr Start Block Block_ CommaExpr Factor Term ComparationExpr BinaryExpr SingleExpr ExprOptional ListExprOptional Expr_without_comma Expr_without_comma_ IfElseStatement
...
| LBRACE Statement Statement_ RBRACE {/*$$ = $2;*/}
...
IfElseStatement: IF LPAR Expr RPAR Statement %prec IFCENAS {/*node no = add_to_tree("Null",NULL,0); $$ = add_to_tree("If",NULL,3,$3,$5,no);*/}
| IF LPAR Expr RPAR Statement ELSE Statement {/*$$ = add_to_tree("If",NULL,3,$3,$5,$7);*/}
    ;
